...
function buildPdfPrompt(nameHint, langDirective) {
...
function buildImagePrompt(nameHint, langDirective) {
...
export async function POST(request) {
  try {
    ...
    // Language passed from the client — drives which language Claude responds in
    ...
    const prompt = isPDF ? buildPdfPrompt(nameHint, langDirective) : buildImagePrompt(nameHint, langDirective);
